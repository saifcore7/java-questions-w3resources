...
public class Demo73{
    public static void main(String[] args) {
        ...
        System.out.println((str1.length() > 0 && str2.length() > 0)?str1.substring(0,1) + str2.substring(str2.length() - 1, str2.length()):str1.length() == 0?"#" + str2.substring(str2.length() - 1, str2.length()):str2.length() == 0);
    }
}
